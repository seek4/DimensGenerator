...
public class GenerateValueFiles {
	...
	private final static String SIZETemplate = "<dimen name=\"size{0}\">{1}px</dimen>\n";
	...
	private void generateDPXmlFile(int w,int h){
		...
		File laysFile = new File(fileDir.getAbsolutePath(), "size.xml");
		try {
			...
			pw.close();
			pw = new PrintWriter(new FileOutputStream(laysFile));
			pw.println(sbForSize.toString());
			pw.close();
